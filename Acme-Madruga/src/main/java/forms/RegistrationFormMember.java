...
public class RegistrationFormMember extends Actor {
	...
	public RegistrationFormMember createToMember() {

		final RegistrationFormMember registrationForm = new RegistrationFormMember();
